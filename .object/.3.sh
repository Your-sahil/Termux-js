...
clear;toilet -t -f mono12  "MAFIA" --gay -F border
echo ""
PUT 11 40
echo -e "\e[92mBy\e[1;93m SAHIL X MAFIA\e[1;95m /\e[1;96m MAFIA "
PUT 12 3
echo ""
echo -e "\e[1;31m  [\e[32m√\e[31m] \e[1;91m by \e[1;36mRaj Aryan \e[93m/ \e[100;92myoutube.com/MAFIA_SAHIL\e[0m"
echo
...
sed -e "s/\MAFIA/$name/g" .MAFIA.zsh-theme > $HOME/.oh-my-zsh/themes/MAFIA.zsh-theme
